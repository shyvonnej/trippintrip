...
//Retrieve persona
$sqlpersonas = "SELECT * FROM tbl_personas";
...
$stmt_personas = $conn->prepare($sqlpersonas);
$stmt_personas->execute();

$number_of_result = $stmt_personas->rowCount();
$number_of_page = ceil($number_of_result / $results_per_page); // round off

$sqlpersonas = $sqlpersonas . " LIMIT $page_first_result, $results_per_page";

$stmt = $conn->prepare($sqlpersonas);
$stmt->execute();
...
<body>
    ...
    <header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
        ...
        <div class="w3-display-middle w3-margin-top w3-center">
            <h1>
                <span class="w3-hide-small w3-text-light-grey"><b>Personas Dashboard
                    </b></span>
            </h1>
        </div>
    </header>
    ...
    <body>
        <section>
            <div class="w3-container w3-padding-15 w3-center" id="content">
                <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Personas Registered</h3>
                <div style="overflow-x:auto;">
                <input class="w3-button w3-round w3-border w3-indigo" type="submit" name="submit" value="Add New Persona" onclick="location.href='addpersonas.php'">
                    <br>
                    <table class="sortable, w3-hoverable" id="persona"
                        style="border:1px solid black;margin-left:auto;margin-right:auto;margin-top:20px;">
                        <thead>
                            <tr>
                                <th class="col-1">ID<i class="fa fa-sort"></i></th>
                                <th class="col-2">Name<i class="fa fa-sort"></i></th>
                                <th class="col-1">Type<i class="fa fa-sort"></i></th>
                                <th class="col-3">Description<i class="fa fa-sort"></i></th>
                                <th class="col-3">Activity<i class="fa fa-sort"></i></th>
                                <th class="col-1">Created At<i class="fa fa-sort"></i></th>
                                <th class="col-1">Updated At<i class="fa fa-sort"></i></th>
                                <th class="col-1"></th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <tr>
          ...
          <td>
            <a href='personasdetails.php?id=" . $id . "' onclick=\"document.getElementById('newsdetails1').style.display='block';return false;\">
