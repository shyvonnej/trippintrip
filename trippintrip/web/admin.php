...
//Retrieve admin
$sqladmins = "SELECT a.*, s.state_name 
FROM tbl_admin a 
...
$stmt_admins = $conn->prepare($sqladmins);
$stmt_admins->execute();

$number_of_result = $stmt_admins->rowCount();
$number_of_page = ceil($number_of_result / $results_per_page); // round off

$sqladmins = $sqladmins . " LIMIT $page_first_result, $results_per_page";
...
<body>
    ...
    <header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
        ...
        <div class="w3-display-middle w3-margin-top w3-center">
            <h1>
                <span class="w3-hide-small w3-text-light-grey"><b>Admins Dashboard
                    </b></span>
            </h1>
        </div>
    </header>
    ...
    <body>
        <section>
            <div class="w3-container w3-padding-15 w3-center" id="content">
                <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Admins Registered</h3>
                <div style="overflow-x:auto;">
                    <br>
                    <table class="sortable, w3-hoverable" id="admin"
        ...
        <tr>
          ...
          <td>
            <a href='admindetails.php?id=" . $id . "' onclick=\"document.getElementById('newsdetails1').style.display='block';return false;\">
